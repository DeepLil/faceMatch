...
def generate_data_pickle_file(config_path, params_path):
    ...
    for actor in actors:
        for file_name in os.listdir(os.path.join(data_path,actor)):
            filenames.append(os.path.join(data_path,actor,file_name))
